...
def test_mongodb_connection():
    ...
    print(f"URI: {mongodb_uri[:50]}...")  # Visa bara början av URI för säkerhet
    ...
    try:
        ...
        if 'affiliate-store' in db_list:
            ...
            print(f"📁 Kollektioner i 'affiliate-store': {', '.join(collections) if collections else 'Inga kollektioner än'}")
